...
pizza_sade_button = tk.Radiobutton(form, text='Vegan Pizza' , fg='black' , bg='pink', activebackground='green', font='Times 16', variable=pizza_var, value=35)
pizza_sade_button.place(relx=0.1, rely=0.37)

pizza_sade_button = tk.Radiobutton(form, text='Akdeniz Pizza' , fg='black' , activebackground='green', font='Times 16', variable=pizza_var, value=30)
pizza_sade_button.place(relx=0.1, rely=0.42)
